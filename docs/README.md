...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-23 22:07:08 UTC<br>状态：成功</p>
</section>
...
<p>今日精读1篇、速读2篇，聚焦全模态嵌入与视觉问答、指代分割新方法。最值得看的是拿下8.0分的《Ovis-Embedding》，探索通用全模态嵌入的边界。普通读者可先读这篇精读，再按兴趣扫两眼两篇6分速读。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Ovis-Embedding: Pushing the Frontiers of Universal Omni-Modal Embeddings">Ovis-Embedding: Pushing the Frontiers of Universal Omni-Modal Embeddings</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Vision And Text Transformer For Predicting Answerability On Visual Question Answering">Vision And Text Transformer For Predicting Answerability On Visual Question Answering</span></li><li><span class="dpr-home-dashboard-paper-title" title="0.5%&gt;100%: Bidirectional Reciprocal Learning for Referring Image Segmentation">0.5%&gt;100%: Bidirectional Reciprocal Learning for Referring Image Segmentation</span></li></ul>
  </div>
