...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-22 22:31:17 UTC<br>状态：成功</p>
</section>
...
<p>精读：《GeoBalance: Geometry-Aware Monitoring and Reconstruction with Asymmetric Optimization for Balanced Multimodal Learning》（8.0/10）</p>
<p>速读：《From Models to Systems: A Comprehensive Survey of Efficient Multimodal Learning》（7.0/10）, 《Low resource cross-modal alignment using HGNN to enhance speech representation》（6.0/10）, 《SPACE: Semantic Projection and Alignment of CLIP Embeddings for Domain Adaptation》（6.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="GeoBalance: Geometry-Aware Monitoring and Reconstruction with Asymmetric Optimization for Balanced Multimodal Learning">GeoBalance: Geometry-Aware Monitoring and Reconstruction with Asymmetric Optimization for Balanced Multimodal Learning</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="From Models to Systems: A Comprehensive Survey of Efficient Multimodal Learning">From Models to Systems: A Comprehensive Survey of Efficient Multimodal Learning</span></li><li><span class="dpr-home-dashboard-paper-title" title="Low resource cross-modal alignment using HGNN to enhance speech representation">Low resource cross-modal alignment using HGNN to enhance speech representation</span></li><li><span class="dpr-home-dashboard-paper-title" title="SPACE: Semantic Projection and Alignment of CLIP Embeddings for Domain Adaptation">SPACE: Semantic Projection and Alignment of CLIP Embeddings for Domain Adaptation</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">ml <strong>9</strong></span></div>
</section>
</div>
