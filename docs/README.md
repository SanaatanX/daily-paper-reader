...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-24 22:12:33 UTC<br>状态：成功</p>
</section>
...
<p>精读：《VCMM: Variance-Calibrated Momentum for Multimodal Learning》（9.0/10）, 《Confidence Falls Short: Asymmetric Certainty Gains from Optimization Hinder Multimodal Classification》（9.0/10）</p>
<p>速读：《MMAP: Multimodal Missing-Aware Pretraining for Longitudinal Alzheimer&#x27;s Prediction》（7.0/10）, 《Small Cues, Big Consequences: Learning Pivotal Cues for Multimodal Meme Classification》（7.0/10）, 《BiCFlow-MER: Orchestrating Discriminative and Generative Multimodal Emotion Recognition via Conditional Transport》（7.0/10）</p>
...
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="VCMM: Variance-Calibrated Momentum for Multimodal Learning">VCMM: Variance-Calibrated Momentum for Multimodal Learning</span></li><li><span class="dpr-home-dashboard-paper-title" title="Confidence Falls Short: Asymmetric Certainty Gains from Optimization Hinder Multimodal Classification">Confidence Falls Short: Asymmetric Certainty Gains from Optimization Hinder Multimodal Classification</span></li><li><span class="dpr-home-dashboard-paper-title" title="From Alignment to Fusion in 3D Vision-Language">From Alignment to Fusion in 3D Vision-Language</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="MMAP: Multimodal Missing-Aware Pretraining for Longitudinal Alzheimer&#x27;s Prediction">MMAP: Multimodal Missing-Aware Pretraining for Longitudinal Alzheimer&#x27;s Prediction</span></li><li><span class="dpr-home-dashboard-paper-title" title="Small Cues, Big Consequences: Learning Pivotal Cues for Multimodal Meme Classification">Small Cues, Big Consequences: Learning Pivotal Cues for Multimodal Meme Classification</span></li><li><span class="dpr-home-dashboard-paper-title" title="BiCFlow-MER: Orchestrating Discriminative and Generative Multimodal Emotion Recognition via Conditional Transport">BiCFlow-MER: Orchestrating Discriminative and Generative Multimodal Emotion Recognition via Conditional Transport</span></li></ul>
  </div>
